  ...
  return {
    ...
    leads: [
      {
        id: "ld-harbor",
        name: "Priya Raman",
        email: "priya@harborpoint.co",
        phone: "",
        role: "Marketing Director",
        company: "Harborpoint Realty",
        website: "harborpoint.co",
        source: "LinkedIn list",
        status: "contacted",
        tags: ["real estate"],
        notes: "Site is a 2019 template — strong redesign candidate.",
        lastContactedAt: d(2),
      ...
      },
      {
        id: "ld-copperleaf",
        name: "Dan Okafor",
        email: "dan@copperleafbrew.com",
        phone: "(512) 555-0184",
        role: "Owner",
        company: "Copperleaf Brewing",
        website: "copperleafbrew.com",
        source: "Local business directory",
        status: "replied",
        tags: ["hospitality"],
        notes: "Replied asking for pricing — wants online ordering.",
        lastContactedAt: d(1),
        convertedContactId: null,
        createdAt: d(6),
      },
      {
        id: "ld-summit",
        name: "Erin Walsh",
        email: "erin@summitptclinic.com",
        phone: "",
        role: "Practice Manager",
        company: "Summit Physical Therapy",
        website: "summitptclinic.com",
        source: "Healthcare outreach list",
        status: "new",
        tags: ["healthcare"],
        notes: "",
      ...
      },
      {
        ...
        email: "marcus@atlaslegal.io",
        phone: "",
        role: "Managing Partner",
        company: "Atlas Legal",
        website: "atlaslegal.io",
      ...
      },
      {
        id: "ld-fernway",
        name: "Sofia Delgado",
        email: "sofia@fernwaystudio.com",
        phone: "",
        role: "Founder",
        company: "Fernway Studio",
        website: "fernwaystudio.com",
        source: "LinkedIn list",
        status: "disqualified",
        tags: ["design"],
        notes: "Just signed with another agency — revisit next year.",
        lastContactedAt: d(9),
        convertedContactId: null,
        createdAt: d(12),
      },
    ...
    invoices: [
      ...
      },
      {
        ...
        companyId: "co-voyagr",
        dealId: "dl-voyagr-1",
        label: "Voyagr — platform build phase 2",
        amount: 18_000,
        issuedAt: d(20),
        dueAt: d(6),
        paidAt: null,
    ...
    payments: [
      ...
      },
      {
        ...
        method: "bank-transfer",
        paidOn: d(12),
        reference: "50% milestone payment",
        createdAt: d(12),
      },
    ],
